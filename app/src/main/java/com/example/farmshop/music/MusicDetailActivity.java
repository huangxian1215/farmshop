...
import com.example.farmshop.music.bean.LrcContent;
...
import com.example.farmshop.music.dialog.Mp3DownLoadChooseDialog;
import com.example.farmshop.music.http.MediaDownloader;
import com.example.farmshop.music.service.MusicService;
import com.example.farmshop.music.task.AudioPlayTask;
import com.example.farmshop.music.util.LyricsLoader;
import com.example.farmshop.music.util.MeasureUtil;
...
import com.example.farmshop.music.widget.AudioController.OnSeekChangeListener;
...
//        tv_artist = (TextView) findViewById(R.id.tv_artist);
        ...
        iv_ambul = findViewById(R.id.iv_ambul);
    ...
    public void initMusic(){
        //显示专辑
        Glide.with(this).load(mMusic.getAlbum()).into(iv_ambul);
        //显示歌词
        setText();
