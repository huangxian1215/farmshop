package com.example.farmshop.music.http;
...
import com.example.farmshop.music.tool.StreamTool;
...
//		conn.setRequestProperty("User-Agent", "Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; WOW64; Trident/4.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; InfoPath.2; .NET4.0C)");
        ...
        if (req_data.host.equals("") != true) {
            conn.setRequestProperty("Host", req_data.host);
            Log.d(TAG, "setConnHeader host="+req_data.host);
        }
