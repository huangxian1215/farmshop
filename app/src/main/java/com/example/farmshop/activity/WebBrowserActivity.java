...
public class WebBrowserActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSearchWord = bundle.getString("baidubaike_search");
        String dis = "";
        try {
            StringBuilder sb = new StringBuilder();
            sb.append(URLEncoder.encode(mSearchWord,"utf-8"));
            dis = sb.toString();
        } catch (UnsupportedEncodingException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
        dis = "baike.baidu.com/item/" + dis;
        et_web_url.setText(dis);
    ...
    private void go(){
        ...
        String url = "https://" + et_web_url.getText().toString();
        Log.d(TAG, "url="+url);
        wv_web.loadUrl(url);
